...
final class AuthPasswordTest extends HttpTestCase
{
    ...
    public function testPasswordFirstThenGoogleLinksOneFile(): void
    {
        ...
        $after = glob($this->dataDir . '/users/*.sqlite') ?: [];
        $this->assertCount(1, $after);
        $this->assertSame($path, $after[0]);
